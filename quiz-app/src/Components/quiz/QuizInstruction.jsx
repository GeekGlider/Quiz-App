...
function QuizInstruction() {
  return (
    <Fragment>
        <Helmet>Quiz Instructions - Quiz App</Helmet>
        <div className='instructions container'>
            ...
            <ul className='browser-default ' id='main-list'>
                ...
                <li>Every Questions contains 4 options
                     <img src={Images.image1} alt="Quiz App options example" />
                </li>
                <li>
                    Select the option which best answers the question by clicking (or selecting) it.
                    <img src={Images.image2} alt="Quiz App answer example" />
                </li>
                <li>
                ...
                <li>
                    ...
                    <img src={Images.image3} alt="Quiz App Fifty-Fifty example"/>
                </li>
                <li>
                    Using a hint by clicking the icon
                    <span className="mdi mdi-lightbulb-on mdi-24px lifeline-icon"></span>
                    will remove one wrong answer leaving two wrong answers and one correct answer.
                    <img src={Images.image4} alt="Quiz App hints example" />
                </li>
